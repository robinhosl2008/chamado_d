...
abstract class BaseActionPeer {
	...
	const CLASS_DEFAULT = 'tarefa.Action';
	...
	const CO_ACTION = 'action.CO_ACTION';

	/** the column name for the NO_ACTION field */
	const NO_ACTION = 'action.NO_ACTION';

	/** the column name for the CO_CONTROLLER field */
	const CO_CONTROLLER = 'action.CO_CONTROLLER';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('CoAction', 'NoAction', 'CoController', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('coAction', 'noAction', 'coController', ),
		BasePeer::TYPE_COLNAME => array (self::CO_ACTION, self::NO_ACTION, self::CO_CONTROLLER, ),
		BasePeer::TYPE_RAW_COLNAME => array ('CO_ACTION', 'NO_ACTION', 'CO_CONTROLLER', ),
		BasePeer::TYPE_FIELDNAME => array ('co_action', 'no_action', 'co_controller', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('CoAction' => 0, 'NoAction' => 1, 'CoController' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('coAction' => 0, 'noAction' => 1, 'coController' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::CO_ACTION => 0, self::NO_ACTION => 1, self::CO_CONTROLLER => 2, ),
		BasePeer::TYPE_RAW_COLNAME => array ('CO_ACTION' => 0, 'NO_ACTION' => 1, 'CO_CONTROLLER' => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('co_action' => 0, 'no_action' => 1, 'co_controller' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(ActionPeer::CO_ACTION);
			$criteria->addSelectColumn(ActionPeer::NO_ACTION);
			$criteria->addSelectColumn(ActionPeer::CO_CONTROLLER);
		} else {
			$criteria->addSelectColumn($alias . '.CO_ACTION');
			$criteria->addSelectColumn($alias . '.NO_ACTION');
	...
	/**
	 * Returns the number of rows matching criteria, joining the related Controller table
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct Whether to select only distinct columns; deprecated: use Criteria->setDistinct() instead.
	 * @param      PropelPDO $con
	 ...
	 * @return     int Number of matching rows.
	 */
	public static function doCountJoinController(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ActionPeer::CO_CONTROLLER, ControllerPeer::CO_CONTROLLER, $join_behavior);
	...
	/**
	 * Selects a collection of Action objects pre-filled with their Controller objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinController(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$criteria = clone $criteria;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			$key2 = ControllerPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = ControllerPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					...
					ControllerPeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded

				// Add the $obj1 (Action) to $obj2 (Controller)
				$obj2->addAction($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ControllerPeer::addSelectColumns($criteria);
		$startcol3 = $startcol2 + ControllerPeer::NUM_HYDRATE_COLUMNS;
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			// Add objects for joined Controller rows

			$key2 = ControllerPeer::getPrimaryKeyHashFromRow($row, $startcol2);
			if ($key2 !== null) {
				$obj2 = ControllerPeer::getInstanceFromPool($key2);
				if (!$obj2) {
				...
				// Add the $obj1 (Action) to the collection in $obj2 (Controller)
				$obj2->addAction($obj1);
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(ActionPeer::CO_ACTION) && $criteria->keyContainsValue(ActionPeer::CO_ACTION) ) {
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(ActionPeer::CO_ACTION);
			$value = $criteria->remove(ActionPeer::CO_ACTION);
			if ($value) {
				$selectCriteria->add(ActionPeer::CO_ACTION, $value, $comparison);
			} else {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(ActionPeer::CO_ACTION, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(ActionPeer::CO_ACTION, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(ActionPeer::DATABASE_NAME);
			$criteria->add(ActionPeer::CO_ACTION, $pks, Criteria::IN);
