		...
		*/
	    ...
	    protected function checkPlatform() {
            ...
            static function close(){
                $objFileLog  = New Base_Util_FileLog();   
                $objFileLog->write("Browser Fechado");
                
                print "<script>window.close();</script>";
            }
            static function reload($page=null){
                $objFileLog  = New Base_Util_FileLog();   
                $objFileLog->write("Browser reload");
                if($page == "opener"){
