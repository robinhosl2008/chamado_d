...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			var sStdMenu = '<select id="num_linhas_select" style="width: 65px" size="1" '+sName+'>';
			var i, iLen;
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "<br /><b>Exibindo de _START_ a _END_ de _TOTAL_ registros</b>",
			 ...
			 *    } );
			 */
			"sLengthMenu": "<b>Quantidade de linhas</b> _MENU_",
	...
	$.extend( DataTable.ext.oPagination, {
		...
		"full_numbers": {
			...
			"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
			{
				...
				$(nPaging).append(
					'<br /><a  tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPageFirst+'">'+oLang.sFirst+'</a>'+
