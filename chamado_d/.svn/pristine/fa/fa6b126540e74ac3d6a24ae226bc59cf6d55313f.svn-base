...
abstract class BasePerfilPeer {
	...
	const CLASS_DEFAULT = 'tarefa.Perfil';
	...
	protected static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::CO_PERFIL, self::NO_PERFIL, self::DS_PERFIL, self::ST_PERFIL, ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::CO_PERFIL => 0, self::NO_PERFIL => 1, self::DS_PERFIL => 2, self::ST_PERFIL => 3, ),
