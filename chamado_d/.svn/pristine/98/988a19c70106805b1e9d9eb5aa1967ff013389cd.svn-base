...
abstract class BaseRecursoPeer {
	...
	const CLASS_DEFAULT = 'tarefa.Recurso';
	...
	protected static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::CO_RECURSO, self::NO_RECURSO, self::DS_RECURSO, self::TP_RECURSO, self::DT_CADASTRO, self::CO_USUARIO_CADASTRO, self::DT_ALTERACAO, self::CO_USUARIO_ALTERACAO, ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::CO_RECURSO => 0, self::NO_RECURSO => 1, self::DS_RECURSO => 2, self::TP_RECURSO => 3, self::DT_CADASTRO => 4, self::CO_USUARIO_CADASTRO => 5, self::DT_ALTERACAO => 6, self::CO_USUARIO_ALTERACAO => 7, ),
	 ...
	 *
	 * @param      Recurso $value A Recurso object.
	...
	{
		return $withPrefix ? RecursoPeer::CLASS_DEFAULT : RecursoPeer::OM_CLASS;
	}
