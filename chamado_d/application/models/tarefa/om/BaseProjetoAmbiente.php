...
/**
 * Base class that represents a row from the 'projeto_ambiente' table.
 *
 * 
 *
 * @package    propel.generator.tarefa.om
 */
abstract class BaseProjetoAmbiente extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'ProjetoAmbientePeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        ProjetoAmbientePeer
	 */
	...
	/**
	 * The value for the st_projeto_ambiente field.
	 * Note: this column has a database default value of: true
	 * @var        boolean
	 */
	protected $st_projeto_ambiente;
	...
	{
		$this->st_projeto_ambiente = true;
	}

	/**
	 * Initializes internal state of BaseProjetoAmbiente object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [st_projeto_ambiente] column value.
	 * 
	 * @return     boolean
	 */
	public function getStProjetoAmbiente()
	{
		return $this->st_projeto_ambiente;
	}
	 ...
	 * @return     ProjetoAmbiente The current object (for fluent API support)
	 */
	public function setCoProjeto($v)
	{
		...
		if ($this->co_projeto !== $v) {
			$this->co_projeto = $v;
			$this->modifiedColumns[] = ProjetoAmbientePeer::CO_PROJETO;
		}
	...
	public function setCoAmbiente($v)
	{
		...
		if ($this->co_ambiente !== $v) {
			$this->co_ambiente = $v;
			$this->modifiedColumns[] = ProjetoAmbientePeer::CO_AMBIENTE;
		}
	...
	/**
	 * Sets the value of the [st_projeto_ambiente] column.
	 ...
	 * @return     ProjetoAmbiente The current object (for fluent API support)
	 */
	public function setStProjetoAmbiente($v)
	{
		if ($v !== null) {
			if (is_string($v)) {
		...
		if ($this->st_projeto_ambiente !== $v) {
			$this->st_projeto_ambiente = $v;
			$this->modifiedColumns[] = ProjetoAmbientePeer::ST_PROJETO_AMBIENTE;
		}

		return $this;
	} // setStProjetoAmbiente()
	...
	{
			if ($this->st_projeto_ambiente !== true) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->st_projeto_ambiente = ($row[$startcol + 2] !== null) ? (boolean) $row[$startcol + 2] : null;
			$this->resetModified();
			...
			return $startcol + 3; // 3 = ProjetoAmbientePeer::NUM_HYDRATE_COLUMNS.

		} catch (Exception $e) {
			throw new PropelException("Error populating ProjetoAmbiente object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ProjetoAmbientePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = ProjetoAmbienteQuery::create()
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				...
				$this->postSave($con);
				ProjetoAmbientePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$affectedRows += ProjetoAmbientePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = ProjetoAmbientePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = ProjetoAmbientePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				return $this->getStProjetoAmbiente();
				break;
			default:
				return null;
				break;
	...
	{
		if (isset($alreadyDumpedObjects['ProjetoAmbiente'][serialize($this->getPrimaryKey())])) {
			return '*RECURSION*';
		}
		$alreadyDumpedObjects['ProjetoAmbiente'][serialize($this->getPrimaryKey())] = true;
		$keys = ProjetoAmbientePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getCoProjeto(),
			$keys[1] => $this->getCoAmbiente(),
			$keys[2] => $this->getStProjetoAmbiente(),
		);
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 1:
				...
				break;
			case 2:
				$this->setStProjetoAmbiente($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setStProjetoAmbiente($arr[$keys[2]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProjetoAmbientePeer::CO_PROJETO)) $criteria->add(ProjetoAmbientePeer::CO_PROJETO, $this->co_projeto);
		if ($this->isColumnModified(ProjetoAmbientePeer::CO_AMBIENTE)) $criteria->add(ProjetoAmbientePeer::CO_AMBIENTE, $this->co_ambiente);
		if ($this->isColumnModified(ProjetoAmbientePeer::ST_PROJETO_AMBIENTE)) $criteria->add(ProjetoAmbientePeer::ST_PROJETO_AMBIENTE, $this->st_projeto_ambiente);
	...
	{
		$criteria = new Criteria(ProjetoAmbientePeer::DATABASE_NAME);
		$criteria->add(ProjetoAmbientePeer::CO_PROJETO, $this->co_projeto);
		$criteria->add(ProjetoAmbientePeer::CO_AMBIENTE, $this->co_ambiente);
	...
	{
		$pks = array();
		$pks[0] = $this->getCoProjeto();
		$pks[1] = $this->getCoAmbiente();
	...
	{
		$this->setCoProjeto($keys[0]);
		$this->setCoAmbiente($keys[1]);
	}
	...
	{
		return (null === $this->getCoProjeto()) && (null === $this->getCoAmbiente());
	}
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ProjetoAmbiente (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setStProjetoAmbiente($this->getStProjetoAmbiente());
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ProjetoAmbiente Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     ProjetoAmbientePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new ProjetoAmbientePeer();
		}
		return self::$peer;
	}
	...
	public function getAmbiente(PropelPDO $con = null)
	{
		if ($this->aAmbiente === null && ($this->co_ambiente !== null)) {
			...
			/* The following can be used additionally to
				...
				$this->aAmbiente->addProjetoAmbientes($this);
			 */
		}
	...
	public function getProjeto(PropelPDO $con = null)
	{
		if ($this->aProjeto === null && ($this->co_projeto !== null)) {
			...
			/* The following can be used additionally to
				...
				undesirable since it could result in an only partially populated collection
				in the referenced object.
				$this->aProjeto->addProjetoAmbientes($this);
			 */
		}
	 ...
	 * If this ProjetoAmbiente is new, it will return
	 ...
	 * Otherwise if this ProjetoAmbiente is new, it will return
	 * an empty collection; or if this ProjetoAmbiente has previously
	 * been saved, it will retrieve related Tarefas from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in ProjetoAmbiente.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	...
	{
		return (string) $this->exportTo(ProjetoAmbientePeer::DEFAULT_STRING_FORMAT);
	}
